...
""" This module contains a normalized spectral clustering implementation to
cluster on firefox feedback data available here
https://wiki.mozilla.org/Firefox/Input/Data
