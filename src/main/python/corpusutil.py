...
""" This module contains a library of various algorithms to do clustering on
firefox feedback data available here https://wiki.mozilla.org/Firefox/Input/Data
